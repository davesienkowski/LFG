...
- ✅ **v1.2 Reliable Delivery — RE-SCOPED to DLVR-04 only — CLOSED 2026-09-07** (Dave). DLVR-04 (failure visibility) delivered and LIVE (migration 0008 applied to prod Neon by Dave 2026-09-07). Email moved OUT of scope: Phase 9 Task 3 (prod creds) WITHDRAWN PERMANENTLY; DLVR-03/plan 10-02 DEFERRED and carried forward (see PROJECT.md backlog). The Phase 9 code seam (`1ad8ac3`) stays shipped/inert (D-02). v1.2 delivered its re-scoped goal, NOT its original "Reliable Delivery" goal.
