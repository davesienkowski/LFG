...
- ✅ **v1.1 Organizer Controls** — Phases 7-8 (shipped 2026-07-07, milestone closed 2026-09-07)
...
### ✅ v1.1 Organizer Controls (Shipped)
...
- [x] **Phase 7: Respondent Tracking & Nudges** — persist invitations, show responded / not-responded status on the admin view, and one-click nudge the non-respondents
- [x] **Phase 8: Scheduling Controls** — optional lazy-close voting deadline plus the organizer's own availability row
